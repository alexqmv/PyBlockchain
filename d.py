...
id = random.randint(1000,5000) # Under maintance | I wanted to create random generation of code verification, maybe  i will do it soon
#id = random.randint(1000,10000)

msg = MIMEMultipart()
msg.attach(MIMEText("                   Your verification code \n\t                               {} \n\n\n\nReply -> \n@help.feedback@mail.ru\n\n\n\n\t\t\t\t\t\t(C) StarEye Blockchain".format(id)))
# Just messages
